 ...
 */
final class Version20211118181702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT NOT NULL, customer_id INT NOT NULL, starts_at DATE NOT NULL, ends_at DATE NOT NULL, total_price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
