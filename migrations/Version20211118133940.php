 ...
 */
final class Version20211118133940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, customer_id INT NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
